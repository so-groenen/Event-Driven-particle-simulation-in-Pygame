...
class CollisionSchedule:
    ...
    def showSchedule(self) -> None:
        ...
        for i, p in enumerate(self.heap):
            if p.collisionType == CollisionType.WALL:
                ...
                print(f"{i}: [PARTICULE] collision Time: {p.getCollisionTime():.5f}, lastUpdate [{p.lastUpdatedTime}, partner: {partner.lastUpdatedTime}] ")
    ...
    def showParticle(self, particle: Particle) -> None:
        if particle.collisionType == CollisionType.WALL:
            ...
            print(f"THIS: [PARTICULE] collision Time: {particle.getCollisionTime():.5f}, lastUpdate [{particle.lastUpdatedTime}, partner: {partner.lastUpdatedTime}] ")
